...
Spark's own recap for the month reports two collateral records, WBTC supply passing 3,000 units on 1 August and wstETH supply passing $3B on 21 August [3]. Both check out against the reserve data.
...
One independent check before moving on. Reserve supply of **$6.45B** less borrows of **$2.02B** gives **$4.42B**, against the **$4.4B** SparkLend TVL Spark published for the same date [3]. The on-chain read and the protocol's own figure agree.
...
Two things would change that picture, and they are the signals I will be watching in September. The Sky Savings Rate falling, which lowers Spark's cost of capital directly. Or the Liquidity Layer earning more on the half of its book that sits outside SparkLend. August delivered neither.

## Methodology and coverage

**Window.** 1 to 31 August 2026, a complete calendar month, compared against 1 to 31 July 2026. Both are 31 days, so no day-count normalisation is required.

**Sources.** All fee, revenue, spread and Liquidity Layer composition figures come from Spark's own published financials at data.spark.finance [2], operated by Block Analitica. Deposits, per-chain splits, the peer set and prices come from DefiLlama [1]. SparkLend collateral composition is read on-chain from the protocol data provider. Internal consistency was checked with 45 identities before drafting, all passing.

**On DefiLlama's revenue series.** This report does not use DefiLlama's fee and revenue data for the Liquidity Layer. That adapter reads a Dune table published by Spark, one day at a time, and stores whatever it finds. Compare its output against the source and the pattern is clear: it captured 100% to 102% of Spark's reported gross yield every month through April 2026, then **79.9%** in May, **72.6%** in June, **66.9%** in July and **67.9%** in August. Three July days match Spark's records to the dollar while seventeen are short by more than $100,000, and the served series swings **51.6%** day over day where the source moves **4.5%**. Netting a full month of funding cost against a partial month of yield turns a profit into a loss: DefiLlama reports **-$649,334** for the Liquidity Layer in August where Spark's own accounting shows **+$301,520**. The defect has been reported to DefiLlama. It affects the fee adapter only, not the TVL feed this report uses for deposits [5].

**Named gaps.**

- **Net revenue is not a precise figure.** At 3.8% of gross it is the small difference between two large numbers. Blockworks Research agrees with Spark on gross yield to within 1% across four quarters and on Distribution Rewards to within 1%, but books a 2% to 6% lower funding cost, which is enough to change the sign of net in some quarters [6]. Quote gross yield, funding cost and the spread; treat net as a range.
- **Distribution Rewards may be revised.** They settle as a monthly off-chain rebate. Spark's figures matched Blockworks to within 1% on every settled quarter but ran materially below for July and August as of 1 September. No revision had appeared at the time of writing.
- **Savings TVL is not reconciled.** Spark's recap reports $4.9B [3]; its own vault endpoint sums to $3.37B and DefiLlama reports $1.21B. The three count different things and the scope difference has not been resolved, so no Savings figure is used in this report's headline claims.
- **Liquidity Layer composition is a point-in-time read** taken at month end, not an average across the month.
- **The Liquidity Layer's daily revenue is not published first-party**, so the within-month split of earnings is inferred from the daily spread series rather than measured directly.
- **Spark publishes three different totals for the Liquidity Layer**: allocated assets $2.29B, assets $2.64B and total assets $2.72B. This report uses allocated assets throughout except where the spread is quoted, which is calculated on total assets as Spark publishes it.

## References

1. DefiLlama, Spark protocol. https://defillama.com/protocol/spark
2. Spark Data Hub, operated by Block Analitica. https://data.spark.finance
3. Spark, August 2026 recap. https://x.com/sparkfinance
4. Sky Forum, Monthly Settlement Cycle. https://forum.sky.money
5. DefiLlama dimension-adapters, `fees/spark-liquidity-layer`. https://github.com/DefiLlama/dimension-adapters
6. Blockworks Research, Spark. https://blockworks.com/analytics/spark
7. Spark documentation. https://docs.spark.fi
