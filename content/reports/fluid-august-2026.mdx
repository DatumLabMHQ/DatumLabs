...
- **Two deposit figures appear.** The peer table measures `fluid-lending` alone (+7.1%); the headline combines it with Jupiter Lend (+4.5%). Each is labelled where it is used.
- **Revenue is Fluid's own**, from the `fluid` entry. Jupiter Lend's revenue is not added to it. DefiLlama defines that line as interest paid to Jupiter and JUP token holders, and books Fluid's share of the same interest as supply-side revenue, where it cannot be separated.
- **The price-neutral test** holds Jupiter Lend's Solana-linked collateral, 43.2% of supply at month end, at 1 August prices. Sensitivity to the debt-side assumption is reported in the text.
...
1. Datum Labs, "Fluid Research Terminal," live dashboard. https://datumlab.xyz/fluid-terminal
2. Token Terminal, "Fluid Q2 2026 Report," August 2026. https://tokenterminal.com/explorer/projects/instadapp
3. Fluid, "Jupiter Lend v2 Is Live: Powered by Fluid," 10 August 2026. https://fluid.io/blog/general-jupiter-lend-v2-is-live-powered-by-fluid
4. Fluid, "Fluid H1 2026 Recap," 5 August 2026. https://fluid.io/blog/general-fluid-h1-2026-recap
5. DefiLlama, protocol and DEX data. https://defillama.com/protocol/fluid-lending
6. Fluid, first-party API. https://api.fluid.instadapp.io/v2/1/vaults
